...
class Config(object):
    ...
    #APP_VER     = '7.14.0'
    CARRIER     = '51089, 1-0'
    SYSTEM_NAME = 'katok suwek'
    #SYSTEM_VER  = '10.12.0'
    IP_ADDR     = '8.8.8.8'
    EMAIL_REGEX = re.compile(r"[^@]+@[^@]+\.[^@]+")

    def __init__(self):
        self.APP_NAME = 'WIN10\t5.5.5\tINC_FORCE\t11.2.5' #% (self.APP_TYPE, self.APP_VER, self.SYSTEM_NAME, self.SYSTEM_VER)
        self.USER_AGENT = 'Line/8.12.2' #% self.APP_VER