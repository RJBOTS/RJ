...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='TOKEN KAMU BRAY')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='TOKEN KAMU BRAY')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='TOKEN KAMU BRAY')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='TOKEN KAMU BRAY')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='TOKEN KAMU BRAY')
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"Hai kk GINTIP MULU SINI GABUNG",
    "Respontag":"HADIR",
...
def help():
    ...
    helpMessage = "▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬\n" + \
                  ...
                  "║☯➸" + key + "Listprotect\n" + \
                  "╚══[     вoтaĸ вoт      ]\n" + \
                  " jika sudah meyeting katik Refresh\n" + \
                  "▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬"
    return helpMessage
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup 「"+str(ginfo.name)+"」 J")
                                except:
                                    pass
